...
class GifRegistry(object):
    ...
    def __init__(
        ...
        self.registry.register(s2b("Registry"), proxy.address, {'from': instanceOperator})
        self.registry.register(s2b("RegistryController"), controller.address, {'from': instanceOperator})
